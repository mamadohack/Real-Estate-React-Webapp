    ...
    <section className="px-5  lg:px-20">
      ...
      <main className="flex py-10 gap-2">
        <div className="w-1/3 p-5 border border-grey-15 rounded-[12px]">
          ...
          <div className="mt-6">
            <img src="/property/Profile.png" alt="" className="inline-block" />
        ...
        <div className="w-1/3 p-5 border border-grey-15 rounded-[12px]">
          ...
          <p className="mt-2 text-grey-60 font-medium">
            Estatein provided us with top-notch service. They helped us sell our
            property quickly and at a great price. We couldn't be happier with
            the results.{" "}
          </p>
          <div className="mt-6">
            <img
        ...
        <div className="w-1/3 p-5 border border-grey-15 rounded-[12px]">
          ...
          <p className="mt-2 text-grey-60 font-medium">
            The Estatein team guided us through the entire buying process. Their
            knowledge and commitment to our needs were impressive. Thank you for
            your support!
          </p>
          <div className="mt-6">
            <img src="/property/Profile-2.png" alt="" className="inline-block" />
            <span className="inline-block ms-3 align-middle font-meduim">
